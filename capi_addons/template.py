...
class Loader:
    ...
    def __init__(self, **globals):  # noqa: A002
        ...
        # So we use the base loader which doesn't have an implementation for including
        # templates
    ...
    def render_string(self, template_str: str, **params: t.Any) -> str:
        ...
        By default, this uses the safe environment which does not have access to
        templates.
        """
        return self._env.from_string(template_str).render(**params)

    def yaml_string(self, template_str: str, **params: t.Any) -> dict[str, t.Any]:
        """
    ...
    def yaml_string_all(self, template_str: str, **params: t.Any) -> dict[str, t.Any]:
        """
        Render the given template string with the given params, parse the result as YAML
